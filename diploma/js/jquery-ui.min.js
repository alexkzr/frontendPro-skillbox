	...
	(C = Math.max),
		...
		(x.fn.position = function (d) {
			...
			var u,
				...
				t,
				m = x(d.of),
				_ = x.position.getWithinInfo(d.within),
			...
			return (
				m[0].preventDefault && (d.at = "left top"),
				(f = e.width),
				(p = e.height),
				(g = e.offset),
				(v = x.extend({}, g)),
				...
				"right" === d.at[0]
					? (v.left += f)
					: "center" === d.at[0] && (v.left += f / 2),
				"bottom" === d.at[1]
					? (v.top += p)
					: "center" === d.at[1] && (v.top += p / 2),
				(u = E(y.at, f, p)),
				(v.left += u[0]),
				(v.top += u[1]),
				this.each(function () {
					var i,
						...
						l = x.extend({}, v),
						c = E(y.my, a.outerWidth(), a.outerHeight());
					"right" === d.my[0]
						? (l.left -= r)
						: "center" === d.my[0] && (l.left -= r / 2),
						"bottom" === d.my[1]
							? (l.top -= h)
							: "center" === d.my[1] && (l.top -= h / 2),
						(l.left += c[0]),
						(l.top += c[1]),
						(i = { marginLeft: e, marginTop: s }),
						x.each(["left", "top"], function (t, e) {
							x.ui.position[w[t]] &&
								x.ui.position[w[t]][e](l, {
									targetWidth: f,
									targetHeight: p,
									elemWidth: r,
									elemHeight: h,
						...
						d.using &&
							(t = function (t) {
								...
								f < r && W(e + i) < f && (o.horizontal = "center"),
									p < h && W(s + n) < p && (o.vertical = "middle"),
									C(W(e), W(i)) > C(W(s), W(n))
